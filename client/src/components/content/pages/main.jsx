    ...
    <div className="homePageflexbox">
      <div className="leftSide">
        <div class="alert alert-secondary" role="alert">
          ...
          <p>Go deeper and lean job-ready skills, practice with real world projects, take assessment and earn cetificants!</p>
        </div>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <p class="card-text">this is a short explanaition about the course , the sunbjects the teacher and so on .</p>
                        <div className="headingInhome">
                          <p class="card-text">
                            <small class="text-muted">starting in : 25 days</small>
                          </p>
                          <button type="button" class="btn-close" onClick={() => removeCourse(course.course_id)}></button>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div className="rightSide">
        <div class="card" style={{ width: "18rem" }}>
          ...
          <div class="card-body">
            ...
            <p class="card-text">we are happy to see you back in our website ready to learn!.</p>
          </div>
